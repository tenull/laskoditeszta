import { Box, Container, Text, Image,Breadcrumb,BreadcrumbItem } from "@chakra-ui/react";
...
const Kapcsolat = () => {
    ...
    return ( 
        ...
        <Box
                // boxShadow='dark-lg'
                backgroundImage={`linear-gradient(rgb(51, 51, 51, 0.7), #c53030),url(../images/pastafactory12.png)`}
                ...
                <Container  display='flex' flexDirection='column' alignItems='center' justifyContent='center' maxW='container.lg' color='white' height='100%'>
                    <Text fontSize={{base:'5xl',md:'6xl'}} fontFamily='Montserrat,sans-serif' fontWeight='bold'>Kapcsolat</Text>
                    <Breadcrumb zIndex={1} fontSize={{base:'xs',md:'sm'}} spacing={{base:'0px',md:'8px'}} separator={<ChevronRightIcon color='gray.400' />}>
                        ...
                        <BreadcrumbItem isCurrentPage>
                            <ReactLink to='#'>Kapcsolat</ReactLink>
                        </BreadcrumbItem>
                    </Breadcrumb>
                </Container >
                <Box
