...
const Szolgaltatas = () => {
    return (
        <Container maxW="container.xl">
            ...
            <Box
                backgroundRepeat="no-repeat" backgroundPosition='right' backgroundSize='300px' backgroundImage={`linear-gradient(rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0.8)), url(../images/rajzteszta.jpg)`}
